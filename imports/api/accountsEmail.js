...
Accounts.emailTemplates.enrollAccount = {
    ...
    text(user, url) {
        ...
        const invitingUser = user.profile.invitedBy ?  '/' + user.profile.invitedBy : "";
        console.log("url char: ", process.env.ROOT_URL[ process.env.ROOT_URL.length -1 ]);
        ...
        if (process.env.ROOT_URL[ process.env.ROOT_URL.length -1 ] === '/'){
            ...
            customUrl = process.env.ROOT_URL + 'enroll-account/' + token + invitingUser
        } else {
