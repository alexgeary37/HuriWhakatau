...
import {
    ...
    GridColumn, GridRow, Sidebar, Divider,
                            ...
                            <Grid doubling>
                                ...
                                <GridRow columns={1}>
                                    <GridColumn width={16}>
                                        ...
                                        <p>A discussion template is where the parameters of a discussion are specified.
                                            There are a number of options (that will be) available to change and see the
                                            effect on the discussion. For example a discussion might have a time limit,
                                        ...
                                        <p>Scenarios are basically the combination of a discussion topic with a
                                            discussion
                                            template. These scenarios can then be reused in different combinations to
                                        ...
                                        <p>A Scenario set simply collects a number of scenarios so that a chained set of
                                        ...
                                        <p>Experiments bring all the preceding components together. Select a group and
                                            Scenario set specify if there will be free chat "introduction" discussion
                                        ...
                                        <p>Additionally, you may specify up to 5 comment rating questions for the
                                            ...
                                            question and display on a user's Dashboard to get a subjective rating of the
                                        ...
                                        <p>On your dashboard there is an "Add User" button that will allow you to
                                            invite specific user to the site. You can choose what roles they may have.
                                            They will need to validate their account before participating.</p>
                                        <Header inverted>What is a "HuiChat"?</Header>
                                        <p>A HuiChat is a discussion format specifically designed for Maori users. It is
                                            an attempt to replicate various cultural practices in an online environment.
                                        ...
                                        <p>This leader will then be the only person able to propose verdicts and
                                            decide when the discussion is complete. Group leaders will also be able to
                                            see the emotional state of participants if they use the emoji next to their
                                            name in the participant list. Also HuiChats will display the user's pepeha
                                            information via hover text associated with their names in the participant
                                            list.</p>
                                    </GridColumn>
                                </GridRow>
                            </Grid>
