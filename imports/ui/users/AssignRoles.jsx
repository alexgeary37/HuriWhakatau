...
export const AssignRoles = ({ toggleModal }) => {
  ...
  return (
    <Modal
      ...
      size="small"
    >
      <Modal.Header className={"userRoles"}>Assign user roles</Modal.Header>
      <Modal.Content>
        <Form as={Segment} attached="bottom">
          ...
          <Modal.Actions>
            <Button content="Submit" positive onClick={handleSubmit} />
            ...
            {!successMsg && !errorMsg && <div style={{ height: "10px" }} />}
          </Modal.Actions>
        </Form>
      </Modal.Content>
    </Modal>
